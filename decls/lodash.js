...
declare module "lodash" {
  ...
  declare type OIterateeNew<K, V, O, R> =
  ...
  declare class Lodash {
    ...
    fromPairs<K, V>(pairs: Array<[K, V]>): { [key: K]: V },
    ...
    partition<T>(array: ?$ReadOnlyArray<T>, predicate?: Predicate<T>): NestedArray<T>,
    ...
    invert<K, V>(object?: ?{ [key: K]: V }, multiVal?: boolean): {[key: V]: K},
    ...
    mapValues<K, V, T: { [k: K]: V }, R>(object?: ?T, iteratee?: OIterateeNew<K, V, T, R>): { [k: K]: R },
